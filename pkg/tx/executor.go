...
func WithCtxGetter(ctxGetter ctxGetter) DbOption {
...
func NewTxDb(defaultTr trmpgx.Tr, options ...DbOption) DB {
	executor := &executor{
		defaultTr: defaultTr,
...
// Returns:
// - trmpgx.Tr: The transaction to use.
func (e *executor) tr(ctx context.Context) trmpgx.Tr { //nolint:ireturn // lib
...
func (e *executor) Exec(
	...
	return e.tr(ctx).Exec(ctx, sql, arguments...)
}
...
// - pgx.Rows: The result of the query.
// - error: An error if the query execution fails.
func (e *executor) Query( //nolint:ireturn // lib
	ctx context.Context,
	sql string,
	arguments ...interface{},
) (pgx.Rows, error) {
	return e.tr(ctx).Query(ctx, sql, arguments...)
}
...
// Returns:
// - pgx.Row: The result of the query as a single row.
func (e *executor) QueryRow( //nolint:ireturn // lib
	ctx context.Context,
	sql string,
	arguments ...interface{},
) pgx.Row {
...
func (e *executor) SendBatch(ctx context.Context, b *pgx.Batch) pgx.BatchResults {
